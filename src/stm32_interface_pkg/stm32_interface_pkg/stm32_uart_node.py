...
class STM32UARTNode(Node):
    def __init__(self, simulate=False):
        ...
        # ✅ Publish to standard joint_states for MoveIt compatibility
    ...
    def read_from_stm32(self):
        if self.serial_port.in_waiting:
            ...
            # ✅ Publish received data as /joint_states
            js = JointState()
...
def main(args=None):
    ...
    node = STM32UARTNode(simulate=True)  # Set to False to use actual STM32
    try:
        rclpy.spin(node)
